      ...
      <div class="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
        ...
        <form @submit.prevent="handleLogin" class="space-y-5">
          ...
          <button
            ...
            class="w-full py-4 px-6 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold rounded-2xl shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all active:scale-95 mt-8"
          >
        ...
        <div class="mt-8 text-center">
          <p class="text-sm text-gray-600">
            ...
            <router-link to="/register" class="font-bold text-transparent bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text hover:from-emerald-700 hover:to-teal-700 transition-all">
              Register now
            </router-link>
          </p>
        </div>
